...
import com.dnys.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post2 = new Post(null, sdf.parse("21/03/2024"), "Bom dia!", "acordei feliz hoje", new AuthorDTO(maria));
		...
		CommentDTO c3 = new CommentDTO("Tenha um ótimo dia!", sdf.parse("22/03/2024"), new AuthorDTO(alex));
